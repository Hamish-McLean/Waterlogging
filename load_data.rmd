...
# Change '0' to 'Control' in `duration`
e1[, duration := factor(
  gsub("0", "Control", duration), 
  levels = c("Control", "1", "2", "4", "8")
)]
...
e4[, trt_code := factor(paste0(season, duration))]
...
mapping <- c(
  "control" = "Control",
  "winter2" = "2 weeks winter",
  "winter4" = "4 weeks winter",
  "winter8" = "8 weeks winter",
  "spring2" = "2 weeks spring",
  "spring4" = "4 weeks spring",
  "spring8" = "8 weeks spring"
)

e4[, treatment := factor(mapping[trt_code], levels = mapping)]
